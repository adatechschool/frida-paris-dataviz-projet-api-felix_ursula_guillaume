...
input.addEventListener("input", async function autoCompletion () {
...
console.log("Input modifié :", input.value);
    ...
    try {
        console.log("On fetch les suggestions pour :", inputAdded);
        ...
        console.log("Données reçues de l'API suggestions :", data);
        suggestionDiv.innerHTML = "";
